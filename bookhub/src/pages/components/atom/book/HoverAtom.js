        ...
        <div style={props.style} className={"hoverInfo"}>
            ...
            {props.isExplore ?
                <div className="reactionContainer">
                    ...
                    <button id="completed" style={{ width: "75px", fontFamily: "Rockwell", fontSize: "10px", height: "28px", marginLeft: "400px" }} onClick={() => { addBookToCompleted(props.uid, props.data, props.name, props.auth); }}> Completed </button>
                    <button id="completed" style={{ width: "75px", fontFamily: "Rockwell", fontSize: "10px", height: "28px", marginLeft: "400px" }} onClick={() => { addBookToLightReading(props.uid, props.data, props.name, props.auth) }}> Light Reading </button>
                </div> : <></>}
            <div className="infoContainer">
                <h4>Title: {props.name}</h4>
                <h4>Author: {props.authors === undefined ? "" : props.authors[0]}</h4>
                <p style={{ marginRight: "80px" }}>Description: {props.description}</p>
